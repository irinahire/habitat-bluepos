  ...
  return (
    <div className="relative h-full p-4">
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 h-full">
        ...
        <div className="xl:col-span-2 space-y-6 flex flex-col h-full">
          <div className="bg-slate-900 p-3 rounded-2xl border border-slate-800 flex items-center gap-3 shadow-inner">
            ...
            <button 
              ...
              className="flex items-center gap-2 px-4 py-2 bg-emerald-950/50 text-emerald-300 rounded-xl hover:bg-emerald-900 border border-emerald-800 text-xs font-medium transition-colors shrink-0"
            >
        ...
        <div className="bg-slate-900 p-6 rounded-3xl border border-emerald-900/50 flex flex-col justify-between">
