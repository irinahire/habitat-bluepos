...
export function AuthButton() {
  ...
  // Extraemos la información real del usuario exactamente igual que en tu código original
  ...
  // Contenido del modal inyectado mediante Portal al body
    ...
    <div className="fixed inset-0 z-[99999] flex items-center justify-center bg-black/80 backdrop-blur-md p-4">
      <div className="relative w-full max-w-md rounded-2xl border border-white/15 bg-gray-950 p-8 shadow-2xl">
        ...
        <div className="text-center mb-6">
          <h3 className="text-2xl font-bold text-white mb-2">BluePOS</h3>
      ...
      {user || claims ? (
        <div className="user-profile flex items-center gap-3">
          <img 
            src={userAvatar} 
            alt="Avatar" 
            className="user-avatar w-8 h-8 rounded-full object-cover" 
          />
